...
export const projectsData: Project[] = [
  {
    ...
    description:
      "Temel React kavramlarını öğrenmek için mükemmel bir başlangıç projesi. useState, event handling ve list rendering konularını pratik edeceksiniz.",
    difficulty: "easy",
    duration: "2-3 saat",
  ...
  },
  {
    ...
    description:
      "React state yönetiminin temellerini öğrenmek için basit ama etkili bir proje. useState hook'unu pratik edeceksiniz.",
    difficulty: "easy",
    duration: "1-2 saat",
  ...
  },
  {
    ...
    description:
      "API entegrasyonu ve useEffect hook kullanımını öğrenmek için ideal bir proje. Gerçek veri çekme deneyimi yaşayacaksınız.",
    difficulty: "medium",
    duration: "4-6 saat",
  ...
  },
  {
    ...
    description:
      "Arama fonksiyonalitesi ve API entegrasyonu ile React'in gücünü keşfedin. Kullanıcı etkileşimi ve veri yönetimi konularını öğreneceksiniz.",
    difficulty: "medium",
    duration: "5-7 saat",
  ...
  },
  {
    ...
    description:
      "React'in resmi dokümantasyonunda yer alan klasik proje. State yönetimi, component yapısı ve oyun mantığı konularını öğreneceksiniz.",
    difficulty: "medium",
    duration: "3-4 saat",
  ...
  },
  {
    ...
    description:
      "Karmaşık state yönetimi, routing ve API entegrasyonu ile gerçek dünya projesi deneyimi. İleri seviye React konularını öğreneceksiniz.",
    difficulty: "hard",
    duration: "2-3 hafta",
    technologies: [
      "React",
  ...
  },
  {
    ...
    description:
      "Veri görselleştirme, tablo yönetimi ve karmaşık UI componentleri ile profesyonel bir dashboard projesi.",
    difficulty: "hard",
    duration: "3-4 hafta",
  ...
  },
  {
    ...
    description:
      "React frontend, Node.js backend ve veritabanı entegrasyonu ile tam kapsamlı bir uygulama. Gerçek dünya projesi deneyimi.",
    difficulty: "expert",
    duration: "1-2 ay",
    technologies: [
      "React",
