    ...
    return (
      ...
      >
        <motion.div
          initial={{ y: 50 }}
          animate={{ y: 0 }}
          className="bg-white dark:bg-secondary-800 rounded-lg p-8 max-w-md w-full"
        >
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold brand-h mb-4">
              Quiz Tamamlandı!
            </h2>

            <div className="space-y-4 mb-6">
              <div className="flex justify-between items-center">
                <span className="brand-sub">Skor:</span>
                <span
              ...
              <div className="flex justify-between items-center">
                <span className="brand-sub">Doğru:</span>
              ...
              <div className="flex justify-between items-center">
                <span className="brand-sub">Yanlış:</span>
              ...
              <div className="flex justify-between items-center">
                <span className="brand-sub">Süre:</span>
  ...
  return (
    ...
    >
      <motion.div
        initial={{ y: 50 }}
        animate={{ y: 0 }}
        className="bg-white dark:bg-secondary-800 rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto"
      >
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-xl font-bold brand-h">{quiz.title}</h2>
            <p className="text-sm brand-sub">{quiz.description}</p>
          </div>
        ...
        <div className="mb-6">
          <div className="flex justify-between text-sm brand-sub mb-2">
            <span>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="mb-6">
              <h3 className="text-lg font-semibold brand-h mb-4">
        ...
        <div className="flex justify-between items-center">
          <button
            onClick={onClose}
            className="brand-sub hover:text-primary-500 transition-colors"
          >
            Çıkış
          </button>
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg font-semibold transition-colors ${
              selectedAnswer !== null
                ...
                : "bg-gray-300 dark:bg-secondary-700 brand-sub cursor-not-allowed"
            }`}
          >
